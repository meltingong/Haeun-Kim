...
public class StringUseMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("------------lnegth-----------");
		int length1 = str1.length();
		int length2 = str2.length();
		int length3 = "집에 가고싶다".length();
		String emptyStr = "";
		...
		System.out.println("오늘은 금요일 String 클래스를 공부해요.".substring(8,14));
		System.out.println("---------charAt--------");
		String userId = "testST#00";
		char firstChar = userId.charAt(0);
		System.out.println(" >> 아이디 첫글자는 영문대(소)문자여야 한다");
		 ...
		 * 		김씨를 새로운 배열에 담아보세요
		 */
		System.out.println("-----------김씨를 새로운 배열에 담아보세요--------------");
